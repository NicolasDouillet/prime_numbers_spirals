...
%     xlabel('Rayon (unité entière)','FontSize',16);
%     ylabel('Rayon (unité entière)','FontSize',16);
%     title({['Spirale des nombres premiers de 5 à ',num2str(N)],'basée sur les cercles de rayons 6n \pm 1'},'FontSize',16); % + vue polaire   
